...
// ----------------------------------------------------------------------------------------------
#define BLUEFRUIT_SWUART_RXD_PIN       0    // Required for software serial! --> BLE module pin
#define BLUEFRUIT_SWUART_TXD_PIN       1    // Required for software serial! --> BLE module pin
#define BLUEFRUIT_UART_CTS_PIN         -1   // Required for software serial!
#define BLUEFRUIT_UART_RTS_PIN         -1   // Optional, set to -1 if unused --> unused


// HARDWARE UART SETTINGS
// ----------------------------------------------------------------------------------------------
// The following macros declare the HW serial port you are using.
// Uncomment this line if you are connecting the BLE to Leonardo/Micro or Flora. --> Flora
// ----------------------------------------------------------------------------------------------
#ifdef Serial1    // This makes it not complain on compilation if there's no Serial1
  #define BLUEFRUIT_HWSERIAL_NAME      Serial1
#endif

// Except that it does complain, even if commented out, and this is the only thing that works.
#define BLUEFRUIT_HWSERIAL_NAME      Serial1   
...
// ----------------------------------------------------------------------------------------------
#define BLUEFRUIT_UART_MODE_PIN        -1    // Set to -1 if unused --> unused
